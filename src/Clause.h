...
//        inline bool removeSatisfiedLiterals();
        ...
        inline void setUsedInLearning() { usedInLearning_ = 1; }
        inline void resetUsedInLearning() { usedInLearning_ = 0; }
        inline bool usedInLearning() const { return usedInLearning_; }        
    ...
    private:
        ...
        unsigned int lbd_ : 29;
        unsigned int canBeDeleted_ : 1;
        unsigned int frozen_ : 1;
        unsigned int usedInLearning_ : 1;
};

Clause::Clause(
    unsigned reserve ) : lbd_( 0 ), canBeDeleted_( 1 ), frozen_( 0 ), usedInLearning_( 0 )
{
